...
TestConservative <- t(select(c(Seat,con_2015)))
TestLabour <- t(select(c(Seat,lab_2015)))
TestLibDem <- t(select(c(Seat,ld_2015)))
TestUKIP <- t(select(c(Seat,ukip_2015)))
  ggplot() + 
  geom_point(aes(x=leave_share,y=con_2015),data= TestConservative, col()="blue")+
  geom_smooth(aes(x=leave_share,y=con_2015),data= TestConservative, col()="blue")+
    geom_point(aes(x=leave_share,y=lab_2015),data= TestLabour, col()="red")+
  geom_smooth(aes(x=leave_share,y=lab_2015),data= TestLabour, col()="red")+
    geom_point(aes(x=leave_share,y=ld_2015),data= TestLibDem, col()="orange")+
    geom_smooth(aes(x=leave_share,y=ld_2015),data= TestLabour, col()="orange")+
    geom_point(aes(x=leave_share,y=ukip_2015),data= TestUKIP, col()="yellow")+
   geom_smooth(aes(x=leave_share,y=ukip_2015),data= TestUKIP, col()="yellow")+
