...
brexit_results %>%
  ggplot() + 
  geom_point(aes(x=leave_share,y=con_2015),colour="blue")+
  geom_smooth(aes(x=leave_share,y=con_2015),colour="blue")+
    geom_point(aes(x=leave_share,y=lab_2015), colour="red")+
  geom_smooth(aes(x=leave_share,y=lab_2015), colour="red")+
    geom_point(aes(x=leave_share,y=ld_2015), colour="orange")+
    geom_smooth(aes(x=leave_share,y=ld_2015), colour="orange")+
    geom_point(aes(x=leave_share,y=ukip_2015), colour="yellow")+
   geom_smooth(aes(x=leave_share,y=ukip_2015), colour="yellow")+
